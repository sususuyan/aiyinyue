...
public class GLImageGaussPassFilter extends GLImageFilter {
    ...
    public GLImageGaussPassFilter(Context context) {
        this(context, OpenGLUtils.getShaderFromAssets(context, "beauty/vertex_gaussian_pass.glsl"),
                OpenGLUtils.getShaderFromAssets(context, "beauty/fragment_gaussian_pass.glsl"));
    }
