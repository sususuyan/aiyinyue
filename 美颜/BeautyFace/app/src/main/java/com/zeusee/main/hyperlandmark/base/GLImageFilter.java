package com.zeusee.main.hyperlandmark.base;
...
import com.zeusee.main.hyperlandmark.ShaderUtils;
import com.zeusee.main.hyperlandmark.utils.OpenGLUtils;
import com.zeusee.main.hyperlandmark.utils.TextureRotationUtils;
...
public class GLImageFilter {
    ...
    public GLImageFilter(Context context, String vertexShader, String fragmentShader) {
        ...
        // 记录shader数据
        //mVertexShader = ShaderUtils.getShaderFromAssets(mContext, "beauty/vertexShader.glsl");
        //mFragmentShader = ShaderUtils.getShaderFromAssets(mContext, "beauty/fragmentShader.glsl");
    ...
    public void initProgramHandle() {
        ...
        if (!TextUtils.isEmpty(mVertexShader) && !TextUtils.isEmpty(mFragmentShader)) {
            ...
            uSTMMatrixHandle = GLES20.glGetUniformLocation(mProgramHandle,"uSTMatrix");
            mIsInitialized = true;
        } else {
    ...
    public boolean drawFrame(int textureId, FloatBuffer vertexBuffer,
        ...
        GLES20.glBufferData(GLES20.GL_ARRAY_BUFFER, textureVertexData.length * 4, textureBuffer, GLES20.GL_STATIC_DRAW);
...
*/
    ...
    public int drawFrameBuffer(int textureId, FloatBuffer vertexBuffer, FloatBuffer textureBuffer) {
      ...
      //  initFrameBuffer(mDisplayWidth,mDisplayHeight);
        // 绑定FBO
        bindFrameBuffer();
